        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    EncryptedSiteName = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    EncryptedServerIp = table.Column<string>(type: "TEXT", nullable: true),
                    EncryptedHostname = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    ServerPublicKey = table.Column<string>(type: "TEXT", nullable: false),
                    EncryptedServerPrivateKey = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RsaKeySessions", x => x.SessionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsCurrentSession = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordEntries_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RsaKeySessions_UserId",
                table: "RsaKeySessions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RsaKeySessions_UserId_IsActive",
                table: "RsaKeySessions",
